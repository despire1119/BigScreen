<template>
  <div class="home" style="width: 100%; height: 100%; positon: relative">
    <div class="top-bar">
      ...
      <span class="title">泗洪县公安局警务监督平台</span>
      <span class="logo">
        <ul class="range-opt">
          ...
          <div class="table-area meal-table">
            <table>
              <tr class="table-header">
                ...
                <th class="rows">人均接处警</th>
                <th class="rows">人均办案</th>
...
export default {
  ...
  methods: {
    districtSearch(map, string, callback) {
